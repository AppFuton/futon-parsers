package io.github.landwarderer.futon.parsers.ksp
...
class ParserProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val symbols = resolver.getSymbolsWithAnnotation("io.github.landwarderer.futon.parsers.MangaSourceParser")
        ...
        val factoryFile =
            try {
                codeGenerator.createNewFile(
                    ...
                    packageName = "io.github.landwarderer.futon.parsers",
        ...
        val sourcesFile =
            try {
                codeGenerator.createNewFile(
                    dependencies = dependencies,
                    packageName = "io.github.landwarderer.futon.parsers.model",
    ...
    private fun writeContent(
        ...
        factoryWriter?.write(
			...
			import io.github.landwarderer.futon.parsers.core.MangaParserWrapper
